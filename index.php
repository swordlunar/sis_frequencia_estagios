                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form>
                                        <div data-mdb-input-init class="form-outline mb-4">
                                            ...
                                            <input id="usuario" class="form-control"placeholder="Digite seu usuário" value='2016105444'/>
                                        </div>
                                        ...
                                        <div class="text-center pt-1 mb-5 pb-1">
                                            <button data-mdb-button-init data-mdb-ripple-init onclick="realiza_login()" class="btn btn-botao btn-block fa-lg gradient-custom-2" style = 'padding: 0.7rem; border-radius: 1rem; width: 100%;' type="button">Entrar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
